...
* `smc_results/`:  Outputs of Sequential Monte Carlo sampling (pyMC). The pickle files storing traces have the following name convention `dataset_gene_model_trace.pickle`.
